...
class catwalkpoison_update_detail(generic_update_detail):
    def __init__(self):
        generic_update_detail.__init__(self, "キャットウォーク",0)
    ...
    def get_genre_list(self, soup):
        ...
        elements = element.find_all("a")
        return list(set([element.text for element in elements]))
...
if __name__ == '__main__':
    studio  =  catwalkpoison_update_detail()
    try:
        studio.process_all()
    finally:
        del studio
